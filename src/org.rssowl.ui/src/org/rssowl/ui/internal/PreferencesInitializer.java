...
public class PreferencesInitializer implements IPreferencesInitializer {
  ...
  protected void initGlobalDefaults(IPreferenceScope defaultScope) {
    ...
    defaultScope.putBoolean(Preference.DISABLE_JAVASCRIPT.id(), false); //SPM modification
    ...
    /* SPM */
    defaultScope.putBoolean(Preference.HIDE_FB.id(), false);
    defaultScope.putBoolean(Preference.HIDE_GMAIL.id(), false);
    defaultScope.putBoolean(Preference.HIDE_MP3.id(), false);
    defaultScope.putBoolean(Preference.HIDE_LIKE.id(),false);
  ...
  private void initToolbarDefaults(IPreferenceScope defaultScope) {
    ...
    items.add(CoolBarAdvisor.CoolBarItem.SEPARATOR.ordinal());
    //SPM DELETION  items.add(CoolBarAdvisor.CoolBarItem.MARK_READ.ordinal());
    //SPM DELETION  items.add(CoolBarAdvisor.CoolBarItem.MARK_ALL_READ.ordinal());

    /* Label | Sticky */
    //SPM DELETION   items.add(CoolBarAdvisor.CoolBarItem.SEPARATOR.ordinal());
    //SPM DELETION  items.add(CoolBarAdvisor.CoolBarItem.LABEL.ordinal());
    //SPM DELETION items.add(CoolBarAdvisor.CoolBarItem.STICKY.ordinal());
