  ...
  private void onApplySelectedFilter() {
    ...
    if (!selection.isEmpty()) {
      ...
      if (filter.getSearch() == null) {
        ...
        ISearchCondition stateCondition = Owl.getModelFactory().createSearchCondition(stateField, SearchSpecifier.IS, EnumSet.of(State.NEW, State.UNREAD, State.UPDATED));
