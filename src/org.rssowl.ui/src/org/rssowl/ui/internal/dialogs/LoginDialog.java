...
public class LoginDialog extends TitleAreaDialog {
  ...
  private void preload() {
    ...
    /* Modified by Paternoster and Khanna */
    if (fRealm.equals("New mail feed")) //$NON-NLS-1$
    {
      URI gLink =  URI.create(SyncUtils.GMAIL_LOGIN);
      ICredentialsProvider gCredProvider=Owl.getConnectionService().getCredentialsProvider(gLink);
    ...
    /* End modification by Paternoster and Khanna */
