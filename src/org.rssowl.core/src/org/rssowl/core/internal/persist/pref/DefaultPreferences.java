...
public class DefaultPreferences {
  ...
  /** SPM OPTIONS */
  public static final String HIDE_FB = Preference.HIDE_FB.id();
  public static final String HIDE_GMAIL = Preference.HIDE_GMAIL.id();
  public static final String HIDE_MP3 = Preference.HIDE_MP3.id();
  public static final String HIDE_LIKE = Preference.HIDE_LIKE.id();
  ...
  /** Feed View: Layout */
  public static final String FV_LAYOUT_CLASSIC = Preference.FV_LAYOUT_CLASSIC.id();

  /** Feed View: Browser Maximized */
  public static final String FV_BROWSER_MAXIMIZED = Preference.FV_BROWSER_MAXIMIZED.id();
