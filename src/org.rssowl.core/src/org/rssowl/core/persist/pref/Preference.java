...
public enum Preference {
  ...
  /** SPM Options */
  HIDE_GMAIL("org.rssowl.pref.hideGmail", IPreferenceType.BOOLEAN), //$NON-NLS-1$
  HIDE_FB("org.rssowl.pref.hideFb", IPreferenceType.BOOLEAN), //$NON-NLS-1$
  HIDE_MP3("org.rssowl.pref.hideMp3", IPreferenceType.BOOLEAN), //$NON-NLS-1$
  HIDE_LIKE("org.rssowl.pref.hideLike", IPreferenceType.BOOLEAN), //$NON-NLS-1$
  ...
  /** Feed View: Layout */
  FV_LAYOUT_CLASSIC("org.rssowl.ui.internal.editors.feed.LayoutVertical", IPreferenceType.BOOLEAN), //$NON-NLS-1$

  /** Feed View: Browser Maximized */
  FV_BROWSER_MAXIMIZED("org.rssowl.ui.internal.editors.feed.BrowserMaximized", IPreferenceType.BOOLEAN), //$NON-NLS-1$
